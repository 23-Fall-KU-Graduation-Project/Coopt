...
def get_meters(phase, model):
    ...
    for k in range(5): # top5 acc
        meters["top{}_accuracy".format(k+1)] = ScalarMeter(
            "{}_top{}_accuracy".format(phase, k+1)
        )
    for k in range(5): # top5 acc
        meters["top{}_adv_accuracy".format(k+1)] = ScalarMeter(
            "{}_top{}_adv_accuracy".format(phase, k+1)
        )
